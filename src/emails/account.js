...
const sendWelcomeEmail = (email, name) => {
    sgMail.send({
        to: email,
        from: '8singhutkarsh8@gmail.com',
        subject: 'Thanks for joining in!',
        text: `Welcome to the Ni-G-hana, ${name}. We hope that you will enjoy our most delicious West African cuisine.`
    })
}
//suyashgautam@@14
...
const orderDelivered = (email, name, oid, r_id) => {
    sgMail.send({
        to: email,
        from: '8singhutkarsh8@gmail.com',
        subject: `Hi ${name}`,
